...
struct races race5 = {"Miami International Autodrome", "Etats-Unis", 57, 5410, 308326, false};
struct races race6 = {"Circuit de Monaco", "Monaco", 78, 3337, 260286, false};
struct races race7 = {"Circuit de Barcelona-Catalunya", "Espagne", 66, 4657, 307236, false};
...
struct races race15 = {"Marina Bay Street Circuit", "Singapour", 62, 5063, 306143, false};
struct races race16 = {"Suzuka International Racing Course", "Japon", 53, 5807, 307471, false};
struct races race17 = {"Lusail International Circuit", "Qatar", 57, 5418, 308611, true};
...
struct races race21 = {"Las Vegas", "Etats-Unis", 50, 6212, 310050, false};
