...
// Structures des voitures, coureurs, écuries et courses
...
struct races race6 =  {"Circuit inconnu 6",             "???", 60, 5000, 300000, false}; // ex. pour combler l'index
struct races race7 =  {"Circuit de Monaco",             "Monaco", 78, 3337, 260286, false};
struct races race8 =  {"Circuit de Barcelona-Catalunya","Espagne", 66, 4675, 308550, false};
struct races race9 =  {"Circuit Gilles-Villeneuve",     "Canada", 70, 4361, 305270, false};
struct races race10 = {"Red Bull Ring",                 "Autriche", 71, 4318, 306452, true};
struct races race11 = {"Silverstone Circuit",           "Grande-Bretagne", 52, 5891, 306198, false};
struct races race12 = {"Hungaroring",                   "Hongrie", 70, 4381, 306630, false};
struct races race13 = {"Circuit de Spa-Francorchamps",  "Belgique", 44, 7004, 308052, true};
struct races race14 = {"Circuit Zandvoort",             "Pays-Bas", 72, 4259, 306587, false};
struct races race15 = {"Autodromo Nazionale Monza",     "Italie", 53, 5793, 306720, false};
struct races race16 = {"Marina Bay Street Circuit",     "Singapour", 62, 5063, 313906, false};
struct races race17 = {"Suzuka International Racing Course","Japon", 53, 5807, 307471, false};
struct races race18 = {"Lusail International Circuit",   "Qatar", 57, 5418, 308826, true};
struct races race19 = {"Circuit of The Americas",       "Etats-Unis", 56, 5513, 308405, true};
struct races race20 = {"Autódromo Hermanos Rodríguez",  "Mexique", 71, 4304, 305354, false};
struct races race21 = {"Autódromo José Carlos Pace",    "Brésil", 71, 4309, 305879, true};
struct races race22 = {"Las Vegas",                     "Etats-Unis", 50, 6201, 310050, false};
struct races race23 = {"Yas Marina Circuit",            "Emirats arabes unis", 58, 5281, 306183, false};
struct races race24 = {"Circuit inconnu 24",            "???", 60, 5000, 300000, false};  // pour combler
struct races race25 = {"Circuit inconnu 25",            "???", 60, 5000, 300000, false};  // pour combler

// Remplissage des coureurs
